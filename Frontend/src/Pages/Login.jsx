...
/**
 * REELHOUSE — Login page
 * Matches Register.jsx and the landing page palette/typography,
 * reusing the film-strip sprocket-hole motif as a framing device.
 */
            ...
            {submitted ? (
              <div className="text-center py-6">
                ...
                <p className="text-sm" style={{ color: COLORS.muted }}>
                  Redirecting you to your watchlist...
                </p>
              </div>
            ) : (
