...
/**
 * REELHOUSE — movie discovery landing page
 * Palette: near-black cinema bg, marquee amber + velvet crimson accents
 * Display face: Bebas Neue (marquee lettering) / Body: Work Sans
 * Signature motif: 35mm film sprocket-hole strip, used as the header/footer edge
 * and as section dividers — a literal nod to the subject rather than decoration.
 * Icons: react-icons/fa throughout (no lucide-react).
 */
        ...
        <section className="max-w-6xl mx-auto px-5 sm:px-8 pt-14 pb-16 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p
              ...
              style={{ color: COLORS.muted }}
            >
              Stream thousands of films and series, curated nightly by people
              who actually watch them — no algorithm filler, just the good
              stuff.
            </p>
